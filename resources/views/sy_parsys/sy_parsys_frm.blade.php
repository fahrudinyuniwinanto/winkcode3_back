...
@section('pagetitle')
<h1 class="page-header">Sy Parsys <small> </small></h1>
@endsection
@section('toolbar')
<ol class="breadcrumb pull-right">
    <li><a href="javascript:;">Home</a></li>
    <li><a href="javascript:;">Dashboard</a></li>
    <li class="active">Sy Parsys</li>
</ol>
@stop
@section('content')
...
<div class="panel panel-inverse form-inline" ng-show="f.tab=='list'" id="div1">
    <div class="panel-heading">
        ...
        <h4 class="panel-title">List Sy Parsys</h4>
    </div>
    <div class="panel-body">
        ...
        <div class="pull-right form-inline">
            <a href="{{url('')}}/sy_parsys/dash" class="btn btn-sm btn-info"><i class="fa fa-reply"></i> Halaman
                Dashboard Parsys</a>
            ...
            <button type="button" class="btn btn-sm btn-primary"
                onclick="tableToExcel('table-sy_parsys','data','Data SyParsys')"><i class="fa fa-file-excel-o"></i>
                Excel</button>
        </div>
        <div class="table-responsive">
            <table ng-table="tableList" id="table-sy_parsys" show-filter="false" class="table table-hover"
                ...
                <tr ng-repeat="(k,v) in $data|orderBy:'+id'" class="pointer" ng-click="read(v.id)">
                    ...
                    <td title="'Group'" filter="{value: 'text'}" sortable="'value'">@{{v.group}}</td>
...
<div class="panel panel-inverse" data-sortable-id="form-stuff-1" ng-show="f.tab=='frm'">
    <div class="panel-heading">
        ...
        <h4 class="panel-title">Form Sy Parsys</h4>
    </div>
        ...
        <form class="form-horizontal">
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <input type="text" ng-model="h.value" id="h_value" class="form-control input-sm" maxlength="255">
                </div>
                <div class="col-sm-4">
                    <label title='value'>Group</label>
                    <select ng-model="h.group" id="h_group" class="form-control input-sm">
                        <option ng-repeat="v in [['APP','APP'],['SYS','SYS'],['DEV','DEV']]" ng-value="v[0]">@{{v[1]}}
                        </option>
                    </select>
        ...
        $scope.tableList = new NgTableParams({}, {
            getData: function($defer, params) {
                ...
                return $http.get(SfService.getUrl('/list'), {
                    ...
                    console.log(jdata);
                    $btn.button('reset');
                    $scope.tableList.total(jdata.data.sy_parsys.total);
                    return jdata.data.sy_parsys.data;
                }, function(error) {
                    $btn.button('reset');
