...
@section('pagetitle')
<h1 class="page-header">Sy Group <small> </small></h1>
@endsection
@section('toolbar')
<ol class="breadcrumb pull-right">
    <li><a href="javascript:;">Home</a></li>
    <li class="active">Sy Group</li>
</ol>
@stop
@section('content')
...
<div class="panel panel-inverse form-inline" ng-show="f.tab=='list'" id="div1">
    <div class="panel-heading">
        ...
        <h4 class="panel-title">List Sy Group</h4>
    </div>
    <div class="panel-body">
        ...
        <div class="pull-right form-inline">
            ...
            <button type="button" class="btn btn-sm btn-primary"
                onclick="tableToExcel('table-sy_group','data','Data SyGroup')"><i class="fa fa-file-excel-o"></i>
                Excel</button>
        </div>
        <div class="table-responsive">
            <div class="row">
        <table ng-table="tableList" id="table-sy_group" show-filter="false" class="table table-hover" style="white-space: nowrap;">
...
<div class="panel panel-inverse" data-sortable-id="form-stuff-1" ng-show="f.tab=='frm'">
    <div class="panel-heading">
        ...
        <h4 class="panel-title">Form Sy Group</h4>
    </div>
...
app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
    ...
    item.formData = [{ route:'sy_group', id: $scope.h.id, path: 'sy_group', s: 'i', userid: $scope.f.userid}];
    },
    ...
    swal("",response,"success");
     ...
     $scope.oGallery = function(id) {
        SfService.get('upload_list',{route:'sy_group',id}, function(jdata) {
            console.log(jdata);
        ...
        $scope.tableList = new NgTableParams({}, {
            getData: function($defer, params) {
                ...
                return $http.get(SfService.getUrl('/list'), {
                    ...
                    console.log(jdata);
                    $btn.button('reset');
                    $scope.tableList.total(jdata.data.sy_group.total);
                    return jdata.data.sy_group.data;
                }, function(error) {
                    $btn.button('reset');
