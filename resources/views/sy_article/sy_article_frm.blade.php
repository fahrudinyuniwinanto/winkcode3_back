...
@section('pagetitle')
<h1 class="page-header">Sy Article <small> </small></h1>
@endsection
@section('toolbar')
<ol class="breadcrumb pull-right">
    <li><a href="javascript:;">Home</a></li>
    <li><a href="javascript:;">Dashboard</a></li>
    <li class="active">Sy Article</li>
</ol>
@stop
@section('content')
...
<div class="panel panel-inverse form-inline" ng-show="f.tab=='list'" id="div1">
    <div class="panel-heading">
        ...
        <h4 class="panel-title">List Sy Article</h4>
    </div>
    <div class="panel-body">
        ...
        <div class="pull-right form-inline">
            ...
            <button type="button" class="btn btn-sm btn-primary"
                onclick="tableToExcel('table-sy_article','data','Data SyArticle')"><i class="fa fa-file-excel-o"></i>
                Excel</button>
        </div>
        <div class="table-responsive">
            <table ng-table="tableList" id="table-sy_article" show-filter="false" class="table table-hover"
                ...
                <tr ng-repeat="(k,v) in $data|orderBy:'+id'" class="pointer" ng-click="read(v.id)">
                    ...
                    <td title="'Sub Judul'" filter="{sub_judul: 'text'}" sortable="'sub_judul'">@{{v.sub_judul}}</td>
                    <td title="'Jenis'" filter="{jenis: 'text'}" sortable="'jenis'">@{{v.jenis}}</td>
...
<div class="panel panel-inverse" data-sortable-id="form-stuff-1" ng-show="f.tab=='frm'">
    <div class="panel-heading">
        ...
        <h4 class="panel-title">Form Sy Article</h4>
    </div>
        ...
        <form class="form-horizontal">
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <input type="text" ng-model="h.judul" id="h_judul" class="form-control input-sm" maxlength="255">
                </div>
                <div class="col-sm-4">
                    <label title='sub_judul'>Sub Judul</label>
                    <input type="text" ng-model="h.sub_judul" id="h_sub_judul" class="form-control input-sm"
                        maxlength="255">
                    <label title='jenis'>Jenis</label>
                    <input type="text" ng-model="h.jenis" id="h_jenis" class="form-control input-sm" maxlength="20">
                </div>
                <div class="col-sm-4">
...
<script>
    ...
    SfService.setUrl("{{url('sy_article')}}");
    $scope.f = {
        crud: 'c',
        tab: 'list',
        pk: 'id',
        ...
        $scope.tableList = new NgTableParams({}, {
            getData: function($defer, params) {
                ...
                return $http.get(SfService.getUrl('/list'), {
                    ...
                    console.log(jdata);
                    $btn.button('reset');
                    $scope.tableList.total(jdata.data.sy_article.total);
                    return jdata.data.sy_article.data;
                }, function(error) {
                    $btn.button('reset');
