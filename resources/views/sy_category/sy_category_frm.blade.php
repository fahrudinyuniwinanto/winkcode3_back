...
@section('pagetitle')
<h1 class="page-header">Sy Category <small> </small></h1>
@endsection
@section('toolbar')
<ol class="breadcrumb pull-right">
    <li><a href="javascript:;">Home</a></li>
    <li><a href="javascript:;">Dashboard</a></li>
    <li class="active">Sy Category</li>
</ol>
@stop
@section('content')
...
<div class="panel panel-inverse form-inline" ng-show="f.tab=='list'" id="div1">
    <div class="panel-heading">
        ...
        <h4 class="panel-title">List Sy Category</h4>
    </div>
    <div class="panel-body">
        ...
        <div class="pull-right form-inline">
            ...
            <button type="button" class="btn btn-sm btn-primary"
                onclick="tableToExcel('table-sy_category','data','Data SyCategory')"><i class="fa fa-file-excel-o"></i>
                Excel</button>
        </div>
        <div class="table-responsive">
            <table ng-table="tableList" id="table-sy_category" show-filter="false" class="table table-hover"
                ...
                <tr ng-repeat="(k,v) in $data|orderBy:'+id'" class="pointer" ng-click="read(v.id)">
                    ...
                    <td title="'Value'" filter="{value: 'text'}" sortable="'value'">@{{v.value}}</td>
...
<div class="panel panel-inverse" data-sortable-id="form-stuff-1" ng-show="f.tab=='frm'">
    <div class="panel-heading">
        ...
        <h4 class="panel-title">Form Sy Category</h4>
    </div>
        ...
        <form class="form-horizontal">
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <input type="text" ng-model="h.name" id="h_name" class="form-control input-sm" maxlength="20">
                </div>
                <div class="col-sm-4">
                    <label title='value'>Value</label>
                    <input type="text" ng-model="h.value" id="h_value" class="form-control input-sm" maxlength="100">
...
<script>
    ...
    SfService.setUrl("{{url('sy_category')}}");
    $scope.f = {
        crud: 'c',
        tab: 'list',
        pk: 'id',
        ...
        $scope.tableList = new NgTableParams({}, {
            getData: function($defer, params) {
                ...
                return $http.get(SfService.getUrl('/list'), {
                    ...
                    console.log(jdata);
                    $btn.button('reset');
                    $scope.tableList.total(jdata.data.sy_category.total);
                    return jdata.data.sy_category.data;
                }, function(error) {
                    $btn.button('reset');
